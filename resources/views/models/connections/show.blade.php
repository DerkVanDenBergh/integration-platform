<x-app-layout>
    ...
    <x-subpages.model-table :header="__('Endpoints')" :fields="array('title', 'endpoint', 'protocol', 'method')" :list="$connection->endpoints()" :nestedResource="__('connections/' . $connection->id . '/endpoints')" :resource="__('endpoints')">
        <x-slot name="headers">
