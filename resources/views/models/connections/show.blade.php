<x-app-layout>
    ...
    <x-subpages.model-table :header="__('Authentications')" :fields="array('title', 'type')" :list="$authentications" :nestedResource="__('connections/' . $connection->id . '/authentications')" :resource="__('authentications')" :showView="__(false)">
        <x-slot name="headers">
    ...
    <x-subpages.model-table :header="__('Endpoints')" :fields="array('title', 'endpoint', 'protocol', 'method')" :list="$endpoints" :nestedResource="__('connections/' . $connection->id . '/endpoints')" :resource="__('endpoints')">
        <x-slot name="headers">
