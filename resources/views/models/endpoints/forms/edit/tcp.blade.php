    ...
    <x-subpages.model-form :action="__('/endpoints/' . $endpoint->id)">
        ...
        <x-slot name="fields">
            ...
            <div class="col-span-2">
                ...
                <x-forms.select id="authentication_id" :value="__('id')" :label="__('title')" :selected="$endpoint->authentication_id" :options="$authentications" class="block mt-1 w-full" name="authentication_id" required autofocus />
            </div>
