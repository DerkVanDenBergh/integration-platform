<div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-5">
    ...
    @else
        <div class="border-t-4 border-indigo-500 rounded-b text-indigo-900 px-4 py-3 shadow-md" role="alert">
            <div class="flex">
                <div class="py-1">
    ...
    <a href="/{{ $resource }}/create" class="mt-5 bg-gray-100 hover:bg-indigo-400 hover:text-white transition text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
